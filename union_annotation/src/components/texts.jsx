...
const highlightPhrasesStepInstruction = "In the other sentence, highlight the information you would like to integrate. You should integrate all information that is missing from the sentence you chose previously, or has more specific phrasing.";
